...
public class SapatariaSapato implements Sapataria {
    ...
    public SapatariaSapato(int quantidadeFio, int quantidadeTecido, int tempoParaFazer, BigDecimal valorVenda) {
